...
public class ScrollSnap3 :  Singleton<ScrollSnap3>, IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	void Update() 
	{
		...
		for (int i = 0; i < _pageCount; i++) {
			if (i != _currentPage) {
				this.transform.GetChild(0).GetChild (i).localScale = new Vector3 (0.6f, 1f, 1f);
			} else {
